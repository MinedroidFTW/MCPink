...
namespace MCPink
{
    public class Server
    {
        ...
        public static List<string> devs = new List<string>(new string[] { "p1nkwafflez" });
        ...
        public static string name = "[MCPink] Default";
        public static string motd = "Welcome!";
        public static byte players = 20;
        ...
        public static string customShutdownMessage = "Server shutdown. Rejoin in 10 minutes.";
        ...
        public static void Exit()
        {
            ...
            foreach (string p in players)
            {
                ...
                {
                    Player.Find(p).Kick("Server shutdown. Rejoin in 10 minutes.");
                }
                else
                {
            ...
            delegate(Player p)
            {
                if (!Server.customShutdown)
                {
                    p.Kick("Server shutdown. Rejoin in 10 minutes.");
                }
                else
                {
