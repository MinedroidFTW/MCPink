...
namespace MCPink
{
    public class CmdInfo : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            {
                Player.SendMessage(p, "This server runs on &bMCPink" + Server.DefaultColor + ", which started as MCSharp, and was made much more feature-packed by Zallist, then picked up again and had development continued by Lawlcat, Valek and Zallist.");
