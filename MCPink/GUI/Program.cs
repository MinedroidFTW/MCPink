...
namespace MCPink_.Gui
{
    public static class Program
    {
        ...
        {
            if (Process.GetProcessesByName("MCPink").Length != 1)
            {
                foreach (Process pr in Process.GetProcessesByName("MCPink"))
                {
        ...
        remake:
            try
            {
                ...
                if (foundView[4].Split(' ')[2].ToLower() == "true")
                {
                    ...
                    Console.Title = Server.name + " MCPink Version: " + Server.Version;
                    usingConsole = true;
                ...
                else
                {
                    ...
                    Application.Run(new MCPink.Gui.Window());
                }
            }
        ...
        talk: handleComm("say " + MCPink.Group.findPerm(LevelPermission.Admin).color + "Console: &f" + s);
            handleComm(Console.ReadLine());
        }
