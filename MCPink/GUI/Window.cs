    ...
    public partial class Window : Form
    {
      ...
      /*     if (!Minimized)
        ...
        private void Window_Load(object sender, EventArgs e) {
            ...
            this.Icon = new Icon(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("MCPink.Lawl.ico"));
            ...
            s.Start();
            notifyIcon1.Text = ("MCPink Server: " + Server.name);
        ...
        void SettingsUpdate()
        {
            ...
            if (txtLog.InvokeRequired)
            {
                ...
                this.Text = Server.name + " - MCPink: " + Server.Version;
            }
        }
        ...
        private void Window_FormClosing(object sender, FormClosingEventArgs e) {
            ...
            MCPink_.Gui.Program.ExitProgram(false);
        }
        ...
        private void btnUpdate_Click_1(object sender, EventArgs e) {
            if (!MCPink_.Gui.Program.CurrentUpdate)
                MCPink_.Gui.Program.UpdateCheck();
            else {
