    ...
    static class Scripting
    {
        ...
        public static void CreateNew(string CmdName)
        {
            ...
            sw.Write(
                ...
                Environment.NewLine +
                "\tUse this as a basis for custom commands implemented via the MCPink scripting framework." + Environment.NewLine +
                ...
                "// As a note, MCPink is designed for .NET 3.5." + Environment.NewLine +
                "using System;" + Environment.NewLine +
                Environment.NewLine +
                "namespace MCPink" + Environment.NewLine +
                "{" + Environment.NewLine +
        ...
        public static bool Compile(string commandName)
        {
            ...
            parameters.ReferencedAssemblies.Add("MCPink_.dll");
        ...
        /// </summary>
        /// <param name="name">String to convert to an MCPink class name.</param>
